...
public class CfjItems {
    //public static final Item NEW_ITEM_NAME = registerItem("new_item_name_with_lowercase_and_underscore", new Item(new Item.Settings()));
...
//    public static final Item UnbreakableHoe = registerItem("unbreakable_hoe", UnbreakableTools.UnbreakableHoe);
    ...
    public static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, Identifier.of(ConceptFantasyJourney.MOD_ID, name), item);
    }

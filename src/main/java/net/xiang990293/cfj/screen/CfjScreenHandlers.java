...
public class CfjScreenHandlers {
    public static final ExtendedScreenHandlerType<ConceptSimulatorScreenHandler> CONCEPT_SIMULATOR_SCREEN_HANDLER =
            Registry.register(
                    Registries.SCREEN_HANDLER,
                    new Identifier(ConceptFantasyJourney.MOD_ID, "concept_simulator"),
                    new ExtendedScreenHandlerType(
                            ConceptSimulatorBlockEntity::new
